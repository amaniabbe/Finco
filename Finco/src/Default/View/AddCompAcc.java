...
public class AddCompAcc extends javax.swing.JDialog {
	private DefaultMainView parentframe;

	public AddCompAcc(DefaultMainView parent) {
		super(parent);
		parentframe = parent;
...
//		JRadioButton_Sav.setBounds(36,36,84,24);
	...
	protected void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		...
		parentframe.finco.createCompany(a, parentframe.clientName, parentframe.email, 10);
		ICustomer c = parentframe.finco.findCustomer(parentframe.clientName);
		parentframe.finco.addCompanyAccount(c, parentframe.accountnr);
		dispose();
